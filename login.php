    ...
    $google_client->setClientId('780226633536-e2m3645gq4pjfj3vmfup85hdlp0ec9fr.apps.googleusercontent.com');

    $google_client->setClientSecret('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');

    $google_client->setRedirectUri('http://localhost/Doctor-appointment-system');
